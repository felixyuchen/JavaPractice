public class PrintTaxTable_6_15 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i <= 200; i++) {
            System.out.printf("%-5d%10s%-5d%10s%-5d%18s%-5d%11s%-5d%n", Math.round(income), " ", Math.round(computeTax(status, income)), " ", Math.round(computeTax((status + 1), income)), " ",
                    Math.round(computeTax((status + 2), income)), " ", Math.round(computeTax((status + 3), income)));
            income += 50D;
        }
    }
    ...
    public static double computeTax(int status, double taxableIncome) {
        ...
        if (status == 0) {
            ...
            if (taxableIncome <= 8350)
                ...
                tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 82250) * 0.28 + (186475 - 104425) * 0.33 + (taxableIncome - 186475) * 0.35;
        } else if (status == 3) {
